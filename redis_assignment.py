...
redis_host = 'redis-16051.c10.us-east-1-4.ec2.cloud.redislabs.com'
redis_port = 16051
redis_password =  'qIdqccENBv2jl0eZj5HjEPN68JP7IUdl'
...
def extract_data():
    ...
    data = pd.read_csv('/home/fundi/moringaschool/week8/redis_project/customer_call_logs.csv')
